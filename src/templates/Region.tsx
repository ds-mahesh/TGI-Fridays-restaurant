...
export const getHeadConfig: GetHeadConfig<TemplateRenderProps> = ({
  ...
  return {
    title: `${document.c_meta_title?document.c_meta_title:`TGI Fridays Restaurant in ${document.name} | Find a Local Store`}`,
    charset: "UTF-8",
    ...
    tags: [
      {
      ...
      },
        {
          ...
          attributes: {
            name: "description",
            content:`${document.c_meta_description?document.c_meta_description:`Use this page to find your nearest TGI Fridays Restaurant in ${document.name} and discover the location details you need to visit us today.`}`,
          },
        },
      ...
      //   // /og tags
        ...
        },
        {
          ...
          attributes: {
            ...
            content: `${document.c_meta_description?document.c_meta_description:`Find TGI Fridays Restaurant in ${document.name}. We stock high-quality, robust products at competitive rates.`}`,
          },
        },
        {
          type: "meta",
...

      {
        ...
        attributes: {
          ...
          content: `${document.c_meta_description?document.c_meta_description:`Find TGI Fridays Restaurant ${document.name}. We stock high-quality, robust products at competitive rates.`}`
        },
      },
    ],
  };
